...
const GRADIENT_MOVE_INTERVAL = 15;
const GLOWING_LINE_HEIGHT = 81;
const GLOW_COLOR = "#28FFBF";
...
export const SVGLineGlowAnimateContainer = () => {
  return (
    <div className="hidden lg:flex">
      ...
      <SVGLineGlowAnimate movementDelay={5000} id={2} additionalHeight={20} />
      <SVGLineGlowAnimate movementDelay={3000} id={3} initialGradientY={20} />
    </div>
  );
};
