...
export default function Landing() {
  return (
    ...
    >
      ...
      <motion.div className="place-self-center absolute md:right-0 h-[320px] w-[320px] lg:h-[450px] lg:w-[450px] 2xl:h-[700px] 2xl:w-[700px] flex opacity-90 mb-12 md:mb-0 ">
        <SpinningEarth />
      </motion.div>
